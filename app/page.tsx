...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-400 via-red-400 to-pink-500 h-screen flex items-center justify-center text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/menu"
            className="inline-block px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-full text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
          >
            Explore Our Menu
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4 text-purple-600">Premium Quality</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
              <div className="text-6xl mb-4">👨‍🍳</div>
              <h3 className="text-2xl font-semibold mb-4 text-purple-600">Expert Chefs</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
              <div className="text-6xl mb-4">🚚</div>
              <h3 className="text-2xl font-semibold mb-4 text-purple-600">Fast Delivery</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <div className="space-y-4 text-gray-700">
              <p className="text-lg">
                <strong className="text-purple-600">📍 Address:</strong> 123 Gourmet Street, Food City, FC 12345
              </p>
              <p className="text-lg">
                <strong className="text-purple-600">📞 Phone:</strong> (555) 123-4567
              </p>
              <p className="text-lg">
                <strong className="text-purple-600">✉️ Email:</strong> info@deliciousbites.com
              </p>
              <p className="text-lg">
                <strong className="text-purple-600">🕒 Hours:</strong> Mon-Sun: 10:00 AM - 10:00 PM
              </p>
            </div>
          </div>
        </div>
